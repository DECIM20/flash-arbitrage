...
const getPrices = async (amountInFrontend) => {
    ...
    provider.on('block', async (blockNumber) => {
     ...
     const amountOutFrontendUNIV3_WMATIC_TO_USDC = await quoterContractUniV3Instance.callStatic.quoteExactInputSingle(                  
        ...
        //  console.log('UNI-V3 -BUY :10,000 - WMATIC-FROM-USDC - POLYGON-MAINNET', amount);
        //  console.log('UNI-V3 -SELL :10,000 - WMATIC-TO-USDC - POLYGON-MAINNET', amount1);
...
// Log output
// console.log('SUSHI - BUY : 10000-WMATIC-FROM-USDC-MATIC-MAINNET', amountOutFrontendSUSHI_WMATIC_IN_USDC);
// console.log('SUSHI - SELL: 10000-WMATIC-TO-USDC-MATIC-MAINNET', amountOutFrontendSUSHI_USDC_IN_WMATIC);
